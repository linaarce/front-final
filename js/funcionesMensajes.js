...
function getMensajes(){
    $.ajax({
        url:"http://192.9.149.131:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function postMensajes(){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://192.9.149.131:8080/api/Message/save",
        type:"POST",
        datatype:"JSON",
...
function putMensajes(idBotonActualizar){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://192.9.149.131:8080/api/Message/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteMensajes(idBotonBorrar){
    const swalWithBootstrapButtons = Swal.mixin({
      ...
      swalWithBootstrapButtons.fire({
        ...
        $.ajax({
            url:"http://192.9.149.131:8080/api/Message/"+idBotonBorrar,
            type:"DELETE",
            datatype:"JSON",
            contentType:"application/JSON",
