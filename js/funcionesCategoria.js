...
function getCategoria(){
    $.ajax({
        url:"http://192.9.149.131:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function postCategoria(){
    if($("#name").val().length==0 || $("#description").val().length==0){
        ...
        $.ajax({
            url:"http://192.9.149.131:8080/api/Category/save",
            type:"POST",
            datatype:"JSON",
...
function putCategoria(idBotonActualizar){
    ...
    $.ajax({
        url:"http://192.9.149.131:8080/api/Category/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteCategoria(idBotonBorrar){
    ...
    const swalWithBootstrapButtons = Swal.mixin({
      ...
      swalWithBootstrapButtons.fire({
        ...
        $.ajax({
            url:"http://192.9.149.131:8080/api/Category/"+idBotonBorrar,
            type:"DELETE",
            datatype:"JSON",
            contentType:"application/JSON",
